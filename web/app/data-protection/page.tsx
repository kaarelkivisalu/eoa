  ...
  return (
    <article className="privacy-content">
      <header className="page-intro">
        ...
        <p><strong>Enne avaldamist lisatakse siia vastutava töötleja nimi ja kontaktandmed.</strong></p>
      </header>
      ...
      <section aria-labelledby="data">
        ...
        <p>EOA-l ei ole osalejate kontaktandmeid, mille abil neile kõigile eraldi teade saata. Andmekaitseteade on kättesaadav siin ja võistluste tulemustabelite juurest.</p>
      ...
      <section aria-labelledby="purpose">
        ...
        <p>Tulemuste kogumise, säilitamise ja avaldamise õiguslik alus on isikuandmete kaitse üldmääruse artikli 6 lõike 1 punkt f. Õigustatud huvi on säilitada Eesti olümpiaadide ajalugu, võimaldada varasema saavutuse kontrollimist ning tunnustada õpilase ja juhendaja panust. Nimi võib selleks olla vajalik võistluse tulemustabelis; nimeotsingu, isikuprofiili ja edetabeli puhul piirame õpilaste nähtavust allpool kirjeldatud viisil. Huvide kaalumisel arvestame lapse vanust, tulemust osalejate arvu ja võistluse tingimuste taustal ning nii avaldamise kui ka nime peitmise mõju. Kui inimese nime avalik kuvamine ei ole põhjendatud, peidame tema nime EOA avalikest väljunditest.</p>
        <p>Andmekaitseõigustega seotud pöördumistele vastamiseks töötleme kirjavahetust üldmääruse artikli 6 lõike 1 punkti c alusel osas, milles see on vajalik õigusliku kohustuse täitmiseks. Muude päringute ja veebilehe tehnilise toimimise alus on punkt f: huvi vastata saadud küsimustele ning hoida leht toimivana.</p>
      ...
      <section aria-labelledby="publication">
        ...
        <p>Võistluse tulemustabelis võivad olla nähtavad nimed ja tulemused. Võistluse liik ega koht tabelis ei määra üksi, kas nime näitamine on põhjendatud. Nimepõhises õpilase otsingus, kooli õpilaste nimekirjas, koondtabelis ja isikuprofiilis kuvatakse õpilast siis, kui tal on vähemalt kümme osalemist või vähemalt üks koht esikolmikus. Juhendajate nimepõhisele otsingule ja profiilile seda piiri ei kohaldata. Piir ei peida õpilase nime võistluse tulemustabelist. Kui nime avalik kuvamine on peatatud, jääb tulemus võistluse tabelisse nimeta; selle juures ei näita EOA ka inimese profiililinki, kooli, klassi ega juhendajat.</p>
        <p>Avaldatud võistlustulemused on nähtavad veebikülastajatele ning kättesaadavad ka avaliku API ja üksikvõistluse CSV kaudu. Õpilaste koondedetabeli nimelist CSV allalaadimist ei pakuta; juhendajate koondtabelit saab CSVna alla laadida. Külastajad saavad avaldatust koopia teha; nende edasine iseseisev kasutus ei ole EOA kontrolli all. Veebileht ja andmebaas asuvad Hetzneri Soome serveris; varukoopiad asuvad Hetzneri Saksamaa ja Scaleway Prantsusmaa serverites. Kirjavahetuseks kasutame Google Gmaili. Google võib töödelda kirjavahetuse andmeid ka väljaspool Euroopa Majanduspiirkonda ning kirjeldab oma <a href="https://policies.google.com/privacy/frameworks?hl=et">andmeedastuse kaitsemeetmeid</a>. EOA ei kasuta teisi teenuseosutajaid.</p>
      </section>

      <section aria-labelledby="retention">
        <h2 id="retention">Säilitamine</h2>
        <p>Tulemusi säilitame tuvastataval kujul seni, kuni see on ajaloolise arhiivi eesmärgiks vajalik ja töötlemisel on õiguslik alus. Nimelisel avaldamisel ei ole automaatset aastate arvu: vähemalt kord aastas vaatame üle avaldamisreeglid ja kontrollime valimit, kas nime näitamine on endiselt vajalik saavutuse tõendamiseks või ajaloo talletamiseks, arvestades osaleja vanust, tulemuse laadi, algallika usaldusväärsust ning nii avaldamise kui ka nime peitmise mõju. Vaidlustatud või parandatud kirje vaatame üle viivitamata. Kui inimese nime avaldamine ei ole enam põhjendatud, peidame tema nime avalikest väljunditest; kui ka sisemise tuvastatava kirje eesmärk või alus kaob, kustutame või anonüümime asjaomased andmed.</p>
